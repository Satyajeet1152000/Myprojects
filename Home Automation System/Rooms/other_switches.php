		...
		<div class="table_data">
			...
			<table align="center">
				...
				<tbody>
					...
					$show = "select * from other_switches";
					...
					if($qry)
					{
						while ($getdata = mysqli_fetch_assoc($qry)) 
						{
							...
							<tr>
								...
								<td> 	 
									<input type="checkbox" id="<?php echo $getdata['device_name'].'-other_switches'; ?>" 
									class = "toggle_btn"
									onclick="btnupdate('<?php echo $getdata['device_name'].'-other_switches'; ?>','<?php echo $getdata['device_name']; ?>','other_switches')" <?php echo $getdata['status'] == '1' ? 'checked' : '' ;?>>
								</td>
						</tr>
						<?php
					}
